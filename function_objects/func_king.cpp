...
const char ModifiedKing::className[] = "ModifiedKing";
...
double ModifiedKing::CalculateIntensity( double r )
{
...
double ModifiedKing::GetValue( double x, double y )
{
  double  x_diff = x - x0;
  double  y_diff = y - y0;
...
int ModifiedKing::CalculateSubsamples( double r )
{
  int  nSamples = 1;
