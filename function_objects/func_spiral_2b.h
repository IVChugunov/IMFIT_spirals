/*   Class interface definition for func_spiral_2b.cpp
 *
...
class SpiralArm2b : public FunctionObject {
...
private:
    double x0, y0, PA, ell, r_0, phi_0, r_break_1, phi_break_1, r_break_2, phi_break_2, r_end, phi_end, mu_a_2, mu_a_3, mu_b_2, mu_b_3, mu_c_2, mu_c_3,
           ...
           mu_a_1, mu_b_1, mu_c_1, m_a_1, m_a_2, m_a_3, m_b_1, m_b_2, m_b_3, m_c_1, m_c_2, m_c_3, bn;
};
