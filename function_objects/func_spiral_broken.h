/*   Class interface definition for func_spiral_broken.cpp
 *
...
class SpiralBranchBroken : public FunctionObject {
...
private:
    double x0, y0, is_clockwise, PA, inc, r0, fi0, max_bright, bright_decrease, width_increase,
            outer_width, inner_width, m0, m1, m2, m3, fi_break, l0, l1, l2, l3, fi_max, n, fi_of_max, kp, mp, maximum, cp,
