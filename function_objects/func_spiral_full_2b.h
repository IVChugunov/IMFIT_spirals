/*   Class interface definition for func_spiral_full_2b.cpp
 *
...
class SpiralArmFull2b : public FunctionObject {
...
private:
    double x0, y0, PA, ell, r_0, phi_0, r_break_1, phi_break_1, r_break_2, phi_break_2, r_end, phi_end, mu_a_2, mu_a_3, mu_b_2, mu_b_3, mu_c_2, mu_c_3,
           I_0, part_growth, ih_s, part_cutoff, w_zp, w_i, S_0, S_end, n,
           q, cosPA, sinPA, is_clockwise, m_phi_0, psi_break_1, psi_break_2, psi_end, psi_growth, psi_cutoff,
           mu_a_1, mu_b_1, mu_c_1, m_a_1, m_a_2, m_a_3, m_b_1, m_b_2, m_b_3, m_c_1, m_c_2, m_c_3,
           n_inv, bn, S_zp, S_i,
